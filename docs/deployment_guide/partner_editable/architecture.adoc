...
** A WebSphere Liberty operator, a Kubernetes extension that helps you deploy and manage WebSphere Liberty applications. It watches all namespaces for WebSphere Liberty application pods and maintains the configured state.
